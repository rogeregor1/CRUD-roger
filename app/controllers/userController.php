<?php
	...
	class userController extends mainModel{
		...
		public function registrarUsuarioControlador(){
		    ...
		    if($email!=""){
				if(filter_var($email, FILTER_VALIDATE_EMAIL)){
					$check_email=mainModel::ejecutarConsulta("SELECT usuario_email FROM usuario WHERE usuario_email='$email'");
			...
			$registrar_usuario=mainModel::guardarDatos("usuario", $usuario_datos_reg);

			if($registrar_usuario->rowCount() > 0){
				$alerta=[
					"tipo"=>"limpiar",
		...
		public function eliminarUsuarioControlador(){
		    ...
		    $eliminarUsuario=mainModel::eliminarRegistro("usuario","usuario_id",$id);
		...
		public function actualizarUsuarioControlador(){
		    ...
		    if($this->verificarDatos("[a-zA-Z0-9]{4,100}",$admin_usuario)){
		        $alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
		    ...
		    if($this->verificarDatos("[a-zA-Z0-9$@.-]{7,250}",$admin_clave)){
		    	$alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
